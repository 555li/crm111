...
<body>
	...
	<div style="position: relative; top: 30px; left: 40px;" id="remarkDivList">
		...
		<img title="${remark.createBy}" src="../../image/user-thumbnail.png" style="width: 30px; height:30px;">
			...
			<h5>${remark.noteContant}</h5>
				<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${remark.editFlag=='1'?remark.editTime:remark.creatTime} 由${remark.editFlag=='1'?remark.editBy:remark.creatBy}${remark.editFlag=='1'?'修改':'创建'}</small>
...
<!--			<div style="position: relative; top: -40px; left: 40px;" >-->
<!--				<h5>呵呵！</h5>-->
<!--				<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> 2017-01-22 10:20:10 由zhangsan</small>-->
<!--				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">-->
